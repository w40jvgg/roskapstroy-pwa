const CACHE='rks-pwa-v1.9-rkszip-import-v2';
const LEGACY_PDF_CACHE='rks-generated-pdf-v1';
const CORE=[
 './','./index.html','./styles.css?v=1.9.10','./refinement.css?v=1.9.10','./engineering-card.css?v=1.9.10','./app.js?v=1.9.10','./ui.js?v=1.9.10','./pdf.js?v=1.9.10','./manifest.webmanifest',
 './vendor/pdf-lib.min.js?v=1.9.10','./vendor/fontkit.umd.min.js?v=1.9.10','./vendor/jszip.min.js?v=1.9.10',
