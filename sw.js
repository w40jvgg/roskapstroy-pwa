const CACHE='rks-pwa-v1.9.18-optional-grid-v1';
const LEGACY_PDF_CACHE='rks-generated-pdf-v1';
const CORE=[
 './','./index.html','./styles.css?v=1.9.16','./refinement.css?v=1.9.12','./engineering-card.css?v=1.9.12','./premium.css?v=1.9.13','./desktop.css?v=1.9.14','./remark-simple.css?v=1.9.18','./module-simple.css?v=1.9.18','./app.js?v=1.9.18','./ui.js?v=1.9.12','./pdf.js?v=1.9.18','./manifest.webmanifest',
 './vendor/pdf-lib.min.js?v=1.9.12','./vendor/fontkit.umd.min.js?v=1.9.12','./vendor/jszip.min.js?v=1.9.12','./changelog.js?v=1.9.18','./rd-catalog.js?v=1.9.12',
