const CACHE='rks-pwa-v1.8-photo-layout6';
const LEGACY_PDF_CACHE='rks-generated-pdf-v1';
const CORE=[
 './','./index.html','./styles.css?v=1.8-photo6','./refinement.css?v=1.8-photo6','./engineering-card.css?v=1.8-photo6','./system-ui.css?v=1.8-photo6','./app.js?v=1.8-photo6','./ui.js?v=1.8-photo6','./pdf.js?v=1.8-photo6','./manifest.webmanifest',
 './vendor/pdf-lib.min.js?v=1.8-photo6','./vendor/fontkit.umd.min.js?v=1.8-photo6',
